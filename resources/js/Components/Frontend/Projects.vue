...
const filterdProjects = ref(props.projects.data);
const selectedSkill = ref("all");

const filterProjects = (id) => {
    if (id === "all") {
        filterdProjects.value = props.projects.data;
        selectedSkill.value = id;
    } else {
        filterdProjects.value = props.projects.data.filter((project) => {
    ...
    <div class="container mx-auto">
        ...
        >
            <ul class="flex flex-col lg:flex-row justify-evenly items-center">
                <li class="m-4 cursor-pointer capitalize">
                    <button
                ...
                <li
                    class="m-4 cursor-pointer capitalize"
