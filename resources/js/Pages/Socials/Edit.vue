...
const form = useForm({
    ...
    icon_svg: props.social?.icon_svg,
    user_id: props.social?.user_id,
    social_url: props.social?.social_url,
});

const submit = () => {
    router.post(`/socials/${props.social.id}`, {
        _method: "put",
        name: form.name,
        icon_svg: form.icon_svg,
...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div
                class="max-w-md mx-auto sm:px-6 lg:px-8 bg-white rounded-lg"
            >
