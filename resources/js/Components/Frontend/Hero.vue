...
<template>
    <section
        id="home"
        class="flex lg:h-[85vh] items-center bg-light-primary dark:bg-dark-primary py-32 lg:py-0 overflow-hidden"
    >
        <div
        ...
        >
            <div class="flex flex-col md:flex-row items-center h-full pt-8">
                <div class="flex-1 flex flex-col items-center lg:items-start">
                    ...
                    <p
                        class="pt-4 pb-8 md:pt-6 md:pb-12 max-w-[480px] text-lg text-center lg:text-center"
                    >
                        Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Nesciunt mollitia eaque asperiores reiciendis, sequi
                        odio tempora?
                    </p>
                    <button
